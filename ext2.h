...
#define BITMAP_OFFSET(void)         (BASE_OFFSET + 3*EXT2_BLOCK_SIZE)
#define INODETABLE_OFFSET(disk)        (disk +  5*EXT2_BLOCK_SIZE)
#define DATABLOCK_OFFSET(block_num)      (disk + block_num*BASE_OFFSET)
#define GETTYPE(ip)               (ip->i_mode == EXT2_S_IFREG ? 'f' : 'd')
#define GETTFILETYPE(ip)               (ip->file_type == 1 ? 'f' : 'd')
